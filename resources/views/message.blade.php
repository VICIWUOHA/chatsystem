...
<div class="container">
    <div class="row">
        ...
        <div class="container-flex">
            <div class="panel-header    ">All messages from {{$receiver->name}}</div>
            <hr>
            @if($messages)
            ...
            <div class="panel-body">
                ...
                <div class="mr-3">
                <img  src="/storage/upload/{{$message->sender->picture}}" alt="" width="50px" height="50px">
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('message.send',$receiver->id)}}">
                        ...
                        <div class="form-group row">
                            <label for="receiver_id" class="col-sm-4 col-form-label text-md-right">{{ 'Send a message to' }}</label>
        ...
        <div class="container">
            <div class="form-group row mb-0">
            <div class="col-md-8 offset-md-4">
            <a class="btn btn-primary mb-3" href="{{route('home')}}" role="button">Back to All chats</a>
        </div>
